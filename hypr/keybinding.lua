...
hl.bind(mainMod .. " + SHIFT + 1", hl.dsp.window.move({ workspace = 4 }))
hl.bind(mainMod .. " + SHIFT + 1", hl.dsp.window.move({ workspace = 5 }))
hl.bind(mainMod .. " + SHIFT + 1", hl.dsp.window.move({ workspace = 6 }))
hl.bind(mainMod .. " + SHIFT + 1", hl.dsp.window.move({ workspace = 7 }))
hl.bind(mainMod .. " + SHIFT + 1", hl.dsp.window.move({ workspace = 8 }))
hl.bind(mainMod .. " + SHIFT + 1", hl.dsp.window.move({ workspace = 9 }))
